...
using Vib17.Models;
using Vib17.Models.AccountViewModels;
using Vib17.Services;
...
namespace Vib17.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult LoginWithExternal() => View();
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var info = new ExternalLoginInfo(auth.Principal, provider, providerKey, provider)
                {
